...
#define WIFI_SSID      "paola1111"
#define WIFI_PASS      "123456789"
#define WIFI_CHANNEL   1
#define MAX_STA_CONN   4
#define GPIO_OUTPUT    25  // Pin 26 como salida común para todos los modos
...
<head>\
    ...
    <style>\
        ...
        button { padding: 10px 20px; background-color: #4CAF50; color: white; border: none; border-radius: 4px; cursor: pointer; margin: 0 10px; }\
        button:hover { background-color: #45a049; }\
        button#stopBtn { background-color: #f44336; }\
        button#stopBtn:hover { background-color: #d32f2f; }\
        .hidden { display: none; }\
        .circuit-image { max-width: 100%; height: auto; margin: 20px 0; text-align: center; }\
        .result { margin-top: 20px; padding: 15px; background-color: #f0f0f0; border-radius: 4px; }\
        .tabs { display: flex; margin-bottom: 20px; }\
        .tab { padding: 10px 20px; cursor: pointer; background-color: #e0e0e0; border: 1px solid #ccc; border-bottom: none; border-radius: 4px 4px 0 0; margin-right: 5px; }\
        .tab.active { background-color: white; border-bottom: 2px solid white; }\
        .tab-content { border: 1px solid #ccc; padding: 15px; }\
    </style>\
</head>\
<body>\
    <div class=\"container\">\
        <h1>Emulador de 555 con ESP32</h1>\
        <div class=\"tabs\">\
        ...
        <div class=\"tab-content\" id=\"config-tab\">\
            ...
            <div id=\"pwmOptions\" class=\"hidden\">\
                <div class=\"form-group\">\
                    <label>Potenciómetro externo (GPIO34):</label>\
                    <p>El valor de la resistencia variable se lee directamente del potenciómetro externo.</p>\
                </div>\
                <div class=\"form-group\">\
                    <label for=\"rPWMFixed\">Resistencia fija (Ω):</label>\
        ...
        <div class=\"tab-content hidden\" id=\"docs-tab\">\
            ...
            <ul>\
                ...
                <li>4 SPI</li>\
                <li>2 interfaces I²S</li>\
                <li>2 interfaces I²C</li>\
                <li>3 UART</li>\
            </ul>\
            <h3>Esquemáticos:</h3>\
            <img src=\"data:image/svg+xml;base64,\" alt=\"Esquemático de ESP32\" style=\"max-width: 100%;\">\
            <h3>Emulador de 555:</h3>\
            <p>Este proyecto simula el comportamiento de un circuito integrado temporizador 555 utilizando un ESP32. El usuario puede configurar los parámetros del circuito y ver el resultado en tiempo real.</p>\
            <h4>Tipos de circuitos disponibles:</h4>\
            <ul>\
                <li><strong>Astable:</strong> Produce un tren de pulsos continuo</li>\
                <li><strong>Monostable:</strong> Produce un solo pulso de duración específica cuando se activa</li>\
                <li><strong>PWM:</strong> Modulación por ancho de pulso, donde la resistencia variable se determina mediante un potenciómetro externo</li>\
            </ul>\
        </div>\
    </div>\
    <script>\
